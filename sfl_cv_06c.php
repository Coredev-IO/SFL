...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center"><tr>
    ...
    <form name="new_cv" action="sfl_cv_06c_.php" method="POST" enctype="multipart/form-data">
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="bg_09 txt03">
<tr></tr><th colspan="3" align="left"class="txt09">Areas de Experiencia</th><tr></tr>
...
<select name="canales" class="" size="5" style="width: 250px">
   <?php  do { ?>
   ...
   <?php } while ($qry_canales = mysql_fetch_assoc($query_canales)); ?>
		  ...
		  <td  width="100" align="center"><input type="submit" name="submit" value="agregar" class="form03" /></td> 
...
<select name="especialidad" size="5" style="width: 250px" >
      <?php   do {?>
       ...
       <?php } while ($qry_especialidad = mysql_fetch_assoc($query_especialidad)); ?>
		     ...
		     <td align="center"><input type="submit" name="submit" value="agregar" class="form03" />&nbsp;</td>  
             <td>
   <?php   
 ...
 <select name="producto"  class="" size="5" style="width: 250px">
     <?php do {  ?>
 ...
 <select name="estado"  class="" size="5" style="width: 200px">
     <?php  do {   ?>
 ...
 </select> </td><td  align="center"><input type="submit" name="submit" value="agregar" class="form03" />&nbsp;</td>
 <td>
 ...
 <select name="zona_job" class="" size="5" style="width: 200px">
       <?php  do { ?>
 <option value="<?php echo $qry_zonas['id_cat_zonas']; ?>">&nbsp;&bull;&nbsp;&nbsp;<?php echo $qry_zonas['zonas'];?></option>
	  ...
	  <td align="center"><input type="submit" name="submit" value="agregar" class="form03" />&nbsp;</td><td>
 ...
 <select name="ciudad_job" class="" size="5" style="width: 200px">
       <?php  do {  ?>
 <option value="<?php echo $qry_ciudades['id_cat_ciudades']; ?>">&nbsp;&bull;&nbsp;&nbsp;<?php echo $qry_ciudades['ciudades'];?></option>
 ...
 </select> </td> <td align="center"><input type="submit" name="submit" value="agregar" class="form03" />&nbsp;</td><td>
  <?php    $query_cd= mysql_query("SELECT * FROM app_ciudades_job, cat_ciudades WHERE app_ciudades_job.id_cat_ciudades = cat_ciudades.id_cat_ciudades and  id_cuenta ='" . $id_cuenta. "'");
     ...
     <?php   } while ($qry_cd = mysql_fetch_assoc($query_cd));   ?></td><tr></tr>
		 ...
		 <input type="button" name="continuar" value="Continuar" class="form03"  onClick="location='sfl_cv_07.php?id_cuenta=<?php echo $id_cuenta; ?>'">&nbsp;        

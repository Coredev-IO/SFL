...
<!--  
    <table width="450" border="0" cellspacing="0" cellpadding="0" align="right">
      <tr>
        ...
        <td><input type="text" name="usr" size="10" maxlength="20" placeholder="Usuario" class="form01" /></td>
        ...
        <td width="5"><img src="images/spacer.gif" width="5" height="1" border="0"></td>
        <td align="center" class="txt01"><a href="#" class="txt01">Olvide mi contrase&ntilde;a</a></td>
...
-->
  ...
  <tr>
    <td height="2" class="bg_02"><img src="images/spacer.gif" width="1" height="2" border="0"></td>
  </tr>
  <tr>
    <td>
    
    <table width="300" height="22" border="0" cellspacing="0" cellpadding="0" align="right" class="bg_img_01">
      <tr>
        <td align="right" class="txt01"><a href="sfl_contacto.php" class="txt01">CONT&Aacute;CTANOS</a></td>
        <td width="208" align="right" class="padd_r txt02">01(55) 9000.1500</td>
      </tr>
    </table>

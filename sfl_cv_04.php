    ...
    <div class="box-formulario">
     <form name="refe" role="form" class="form-horizontal" method="post" action="sfl_cv_04_.php" enctype="multipart/form-data">
         ...
         <!--  <div class="form-group">
          ...
          <div class="form-group">
                <label for="ref_tel" class="col-sm-4 control-label">Teléfono :* </label>
                  <div class="col-sm-8">
                    

                  <input onkeypress="return event.keyCode!=13"  type="text" name="ref_tel" size="18" maxlength="15"  <?php if ($ref_tel != "") { ?>value="<?php echo $ref_tel; ?>"<?php } ?> class="form-control" placeholder='Teléfono ' >
        ...
        <div class="form-group">
          ...
          <div class="form-group">
                <label for="time_con" class="col-sm-4 control-label">Tiempo de conocerlos :* </label>
                  ...
                  <input onkeypress="return event.keyCode!=13"  type="number" name="time_con" size="3" maxlength="2"  <?php if ($time_con != "") { ?>value="<?php echo $time_con; ?>"<?php } ?> class="form-control" placeholder='Años ' >

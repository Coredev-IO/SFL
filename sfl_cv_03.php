    ...
    <div class="col-md-9">
      ...
      <div class="box-formulario">
        <form class="form-horizontal" role="form" name="new_cv" action="sfl_cv_03_.php" method="post" enctype="multipart/form-data" >
          ...
          <div class="form-group">
            <label for="TelefonoMovil" class="col-sm-4 control-label">Teléfono Movil : </label>
              <div class="col-sm-8">
                

              <input onkeypress="return event.keyCode!=13"  type="text" name="TelefonoMovil" size="30" maxlength="50" <?php if ($tel_movil != "") { ?>value="<?php echo $tel_movil; ?>"<?php } ?> class="form-control" placeholder='Teléfono Movil ' >

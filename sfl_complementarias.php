...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td><img src="images/sfl_head_int_12.jpg" width="900" height="180" border="0"></td>
  </tr>
  <tr>
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td class="padd_05 txt09a" valign="top">Soluciones Complementarias</td>
  </tr>
  <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="txt06">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="txt03" valign="bottom"><ul>
                  <li>Gesti&oacute;n y Control de Gastos y Herramientas de la Fuerza de Ventas</li>
                  <li>Arrendamiento de Equipos para comunicaci&oacute;n y reporte de las Fuerzas de Ventas</li>
                  <li>Almacenaje, acondicionamiento y env&iacute;o de materiales promocionales a la Fuerza de Ventas</li>
                </ul></td>
                <td width="250" align="right"><img src="images/sfl_ico_07b.jpg" width="200" height="47" border="0" align="right"></td>
              </tr>
            </table>

		...
		$qry_indus = mysql_fetch_assoc($query_indus);
			...
			do {
 				...
 				?>
				  ...
				  <br><br><select style="width: 200px"name="time_expe_pos" class="form03" onChange="MM_jumpMenu('parent',this,0)"><br>
             ...
             <option value="sfl_cv_06a_.php?time_expe_pos=<?php echo "10 años";?>& id_posicion=<?php echo $qry_indus['id_posicion'];?>& id_cuenta=<?php echo $id_cuenta;?>">10 años</option>
                  ...
                  <td class="txt06c" align="center"><a href="sfl_cv_06a_.php?accion=<?php echo"borrar"?>& id_cuenta=<?php echo "$id_cuenta"?> & id_cat_posicion=<?php echo $cat_posicion?>" class="txt06c"><img class="right" src="images/eliminar.gif" alt="ayuda", height="20px" data-toggle="tooltip" data-placement="left" title="Tooltip on left"></a></td>
                 <?php
			$i ++;
			$x ++;
